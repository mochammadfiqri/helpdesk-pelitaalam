                    ...
                    <div class="card z-index-0 fadeIn3 fadeInBottom">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                                <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Email Verification</h4>
                                <div class="row mt-3">
                        ...
                        <div class="card-body">
                            {{-- <form action="" method="POST">
                                    ...
                                    <div class="input-group input-group-outline mt-0 mb-2">
                                        ...
                                        <input type="password" id="confirm_password" name="confirm_password" required
                                            oninput="checkPasswordMatch()" class="form-control" oninput="checkInput(this)"
                            ...
                            <h6 class="text-center">Link email Verifikasi sudah terkirim, harap cek email</h6>
                            {{-- <div class="text-center pt-3">
                                <a href="/email/verification-notification" class="btn btn-rounded bg-gradient-info">Kirim Ulang Email Verifikasi</a>
                            </div> --}}
                        </div>
                    </div>
                </div>
