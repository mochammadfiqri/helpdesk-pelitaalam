            ...
            <div class="col-lg-4 col-md-8 col-12 mx-auto">
                <div class="card z-index-0 fadeIn3 fadeInBottom">
                    ...
                    <div class="card-body mb-n4">
                        <form class="text-start" wire:submit.prevent="login">
                            <div class="mb-3">
                                <label class="form-label">E-Mail</label>
                                <div class="input-group input-group-outline mt-n2">
                                    <input wire:model.defer="email" type="email" class="form-control @error('email') is-valid @enderror" placeholder="xxx@gmail.com">
                                </div>
                                @error('email')
